...
export async function createCheckoutSession(
  ...
  try {
    console.log('⚠️ Stripe checkout creation is disabled for now.');

    // You can return any URL here to simulate checkout flow.
    // For example, redirect to a success page or your own route.
