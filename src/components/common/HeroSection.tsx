...
const HeroSection: FC = () => {
  return (
     ...
     */
    <section className="absolute bottom-0 left-0 right-0 flex justify-center z-10 text-white text-center pb-10 px-4">
      ...
      <div className="max-w-3xl">
        ...
        <Link
          href="/search?q=*"
          className="block bg-white border py-3 mt-4 transition-all uppercase text-xs font-light text-center text-gray-800 rounded-lg hover:bg-gray-200"
