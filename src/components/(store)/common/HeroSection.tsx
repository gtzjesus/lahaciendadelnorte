...
const HeroSection: FC<HeroSectionProps> = ({ className = '' }) => {
  return (
    ...
    >
      ...
      <h1
        className="uppercase font-bold text-5xl lg:text-8xl text-white leading-tight text-center px-4 mt-20
      ...
      <div className="flex justify-center gap-4 w-full max-w-lg px-4 mb-20 ">
        <Link
          href="/"
